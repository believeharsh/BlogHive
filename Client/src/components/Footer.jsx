  ...
  return (
    <footer className="bg-black text-white py-6 px-8 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="flex gap-4 text-sm mt-4 md:mt-0">
        <a href="https://github.com/your-bloghive-repo" target="_blank" rel="noopener noreferrer" className="hover:underline">
          BlogHive GitHub
        </a>
        <a href="https://github.com/HarshDahiya" target="_blank" rel="noopener noreferrer" className="hover:underline">
          My GitHub
        </a>
      </div>
