...
const ProjectCard = ({ name, title, body, coverImage, createdAt }) => {
  ...
  return (
    ...
    <div className="border-b border-gray-300 py-6">
      <div className="flex gap-2">
            <img src={`/images/default_Image.jpeg`} alt="" className="w-6 h-6 rounded-full object-cover border border-gray-300" />
